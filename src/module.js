import WarfareUnitSheet from "./scripts/sheet.js";
import extendActor from "./scripts/unit.js";
...
document.addEventListener("click", (evt) => {
    ...
    if (!target.classList.contains("warfare-config-rm-item") && !parent?.classList.contains("warfare-config-rm-item")) {
